...
class InventorySystem:
    ...
    def log_transaction(self, action: str, borrower_name: str, item_name: str, quantity: int) -> None:
        """Log lending transactions."""
        with open("transaction_log.txt", "a") as log_file:
            log_file.write(f"{action} | {borrower_name} | {item_name} | {quantity}\n")

    def load_transactions(self) -> None:
        """Load transactions from the log file and update inventory."""
        try:
                ...
                for line in log_file:
                    ...
                    if action == "Lend":
                        if item_name in self.inventory:
                            ...
                            print(f"Warning: Item '{item_name}' not found in inventory during loading.")
    ...
    def lend_item(self) -> None:
        ...
        try:
            ...
            # Save inventory after lending an item
            self.save_inventory()
        ...
        if user.borrowed_items:
            ...
            try:
                ...
                if user.return_item(chosen_item, return_quantity):
                    ...
                    # Save inventory after returning an item
                    self.save_inventory()
    ...
    def update_item(self) -> None:
        ...
        if item_name in self.inventory:
            ...
            try:
                ...
                # Save inventory after updating an item
                self.save_inventory()
    ...
    def bulk_add_items(self) -> None:
        ...
        while True:
            ...
            try:
                ...
                # Save inventory after bulk adding items
                self.save_inventory()
